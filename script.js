...
search.addEventListener('keyup', function () {
  ...
  return filterMap(searchText);
});

filterMap = (searchText) => {
  console.log("FilterMap", searchText)
  return dataList.filter(i => { return i.title.toLowerCase().includes(searchText.toLowerCase()) ||
    i.service_area.toLowerCase().includes(searchText.toLowerCase()) ||
    i.category_1.toLowerCase().includes(searchText.toLowerCase()) ||
    i.category_2.toLowerCase().includes(searchText.toLowerCase()) ||
    i.category_3.toLowerCase().includes(searchText.toLowerCase()) ||
    i.contact_name.toLowerCase().includes(searchText.toLowerCase()) ||
    i.contact_email.toLowerCase().includes(searchText.toLowerCase()) ||
    i.contact_number.toLowerCase().includes(searchText.toLowerCase()) ||
